...
class ExpenseProvider with ChangeNotifier {
  ...
  Future<void> addExpense(Expense expense) async {
    final newExpense = await DatabaseHelper.instance.insertExpense(expense);
    
    // Save category mapping for autocomplete
    await DatabaseHelper.instance.insertCategoryMapping(
      expense.name,
      expense.category,
    );

    // Reload expenses if the new expense is in the selected month
  ...
  // Get suggested category for autocomplete
  Future<String?> getSuggestedCategory(String name) async {
    return await DatabaseHelper.instance.getSuggestedCategory(name);
  }
